...
<div>
<h2>Add New Book</h2>
<div style="color:#666;font-size:.95rem;margin-top:6px">Create a new library entry — clean and simple.</div>
</div>
...
<input type="text" name="name_manual" class="input-modern" placeholder="Enter the book name..." disabled>
</div>
<div class="form-group">
<label class="label-title">Description</label>
<textarea name="description_manual" rows="4" class="input-modern" placeholder="Write a short description..." disabled></textarea>
</div>
<div class="form-group">
<label class="label-title">Book Cover Image</label>
<input type="file" name="image_manual" class="input-modern" accept="image/jpeg,image/png,image/jpg,image/gif" disabled>
<div style="font-size:0.85rem;color:#666;margin-top:6px">Accepted formats: JPEG, PNG, JPG, GIF (Max 2MB)</div>
</div>
<div class="form-group">
...
<textarea class="page-textarea" placeholder="Write your book content here..." disabled></textarea>
</div>
</div>
</div>
...
<div class="form-group">
<label class="label-title">Book Name</label>
<input type="text" name="name" class="input-modern @error('name') is-invalid @enderror" placeholder="Enter the book name..." value="{{ old('name') }}">
@error('name')
...
<textarea name="description" rows="3" class="input-modern @error('description') is-invalid @enderror" placeholder="Write a short description...">{{ old('description') }}</textarea>
@error('description')
<span class="text-danger">{{ $message }}</span>
@enderror
</div>
...
<input type="file" name="document_file" class="input-modern @error('document_file') is-invalid @enderror" accept=".pdf,.doc,.docx" id="documentFile" onchange="previewDocument(event)">
<div style="font-size:0.85rem;color:#666;margin-top:6px">Accepted formats: PDF, DOC, DOCX (Max 10MB)</div>
...
<button type="submit" class="btn-pill primary" style="padding:10px 28px">Save Book</button>
</div>
</form>
</div>
</div>
