...
<head>
    ...
    <style>
        ...
        /* ====== FLOATING PILL NAVBAR (REAL PILL) ====== */
        .pill-nav-wrap {
            position: fixed;
            top: 18px;
            left: 50%;
            ...
            box-shadow: 0 10px 30px rgba(8, 10, 12, 0.10), 0 1px 0 rgba(0, 0, 0, 0.02) inset;
        ...
        /* Links group (scrolls on tiny screens) */
        .pill-links {
            display: flex;
            gap: 8px;
            align-items: center;
        ...
        /* USER DROPDOWN (kept OUTSIDE scrollable area) */
        .pill-dropdown {
            position: relative;
            margin-left: 8px;
        }
        ...
        .pill-dropdown-menu {
            ...
            padding: 6px;
            min-width: 180px;
            box-shadow: 0 14px 40px rgba(8, 10, 12, 0.12);
            border: 1px solid rgba(10, 10, 10, 0.06);
            z-index: 1400;
        }
        ...
        /* fallback spacing so content not hidden by floating pill */
        main {
            padding-top: 92px;
        }
        ...
        /* Dashboard pieces (kept from previous styles) */
        .dashboard {
            max-width: 1200px;
            margin: 0 auto;
...
<body>
    <div id="app">
        ...
        <div class="pill-nav-wrap" role="navigation" aria-label="Primary">
            <div class="pill-nav container">
                ...
                <!-- BRAND -->
                <a class="pill-brand" href="{{ route('home') }}">
                ...
                <!-- USER DROPDOWN (outside the scroll container) -->
                @auth
                    <div class="pill-dropdown" aria-haspopup="true">
                        <button class="pill-dropdown-toggle" id="pillDropdownToggle" aria-expanded="false"
                            aria-controls="pillDropdownMenu">
                            {{ Auth::user()->name }}
                        ...
                        <div class="pill-dropdown-menu" id="pillDropdownMenu" role="menu"
                            aria-labelledby="pillDropdownToggle">
    ...
    <script>
        (function () {
            // dropdown toggle with escape & outside click handling
            document.addEventListener('DOMContentLoaded', () => {
                const toggle = document.getElementById('pillDropdownToggle');
                const menu = document.getElementById('pillDropdownMenu');
                ...
                // keyboard accessibility: Esc closes, ArrowDown opens
                document.addEventListener('keydown', (e) => {
                    if (e.key === 'Escape') closeMenu();
                    if (e.key === 'ArrowDown' && document.activeElement === toggle) {
                        e.preventDefault();
                        openMenu();
