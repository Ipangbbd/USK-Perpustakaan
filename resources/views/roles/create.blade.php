...
.input{width:100%;border-radius:10px;padding:10px 12px;border:1px solid #ddd;background:#fdfdfd}
.input:focus{border-color:#000}
.checkbox-group{display:flex;flex-direction:column;gap:8px;max-height:260px;overflow:auto;padding:8px 4px;border:1px solid #ddd;border-radius:12px;background:#fafafa}
.checkbox-item{display:flex;align-items:center;gap:10px;padding:6px 4px}
...
<input type="text" id="name" name="name" value="{{ old('name') }}" class="input @error('name') is-invalid @enderror">
@error('name')
